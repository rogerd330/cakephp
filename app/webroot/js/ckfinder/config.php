...
//    session_start();
//    $isAdmin = $_SESSION['Auth']['User']['group_id'] == 1; // Make sure this user is an admin on the site.
//    $isSuperAdmin = $_SESSION['Auth']['User']['group_id'] == 4; // Make sure this user is an admin on the site.
//    return $isAdmin || $isSuperAdmin; // Make sure this user is an admin on the site.
