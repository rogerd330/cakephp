...
<?php if ($wannaUseSession): ?>
				$this->setFlash(__('The <?php echo strtolower($singularHumanName); ?> could not be saved. Please, try again.'), false);
<?php endif; ?>
			}
		}
<?php
...
<?php if ($wannaUseSession): ?>
		$this->setFlash(__('<?php echo ucfirst(strtolower($singularHumanName)); ?> was not deleted'), false);
<?php else: ?>
